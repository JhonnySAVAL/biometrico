...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.querySelectorAll("[data-bs-target='#editModal']").forEach(button => {
        button.addEventListener("click", function () {
            ...
            formEdit.action = `/biometrico/sistema/controller/AsistenciasController/ExoneracionesController.php?action=ActualizarExoneracion&id=${id}`;
        ...
        button.addEventListener("click", function (e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    formDelete.action = `/biometrico/sistema/controller/AsistenciasController/ExoneracionesController.php?action=EliminarExoneracion&id=${id}`;
                    formDelete.submit();
                }
            });
        });
