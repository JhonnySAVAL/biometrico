                ...
                <nav class="mt-2">
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item menu-close">
                            ...
                            <ul class="nav nav-treeview">
                                <!-- <li class="nav-item">
                                    <a href="/biometrico/sistema/controller/ConfiguracionesController/FeriadosController.php?action=MostrarFeriadosPorAno" class="nav-link">
                                        <i class="nav-icon bi bi-calendar-day"></i>
                                        <p>Feriados por Año</p>
                                    </a>
                                </li> -->
                                <li class="nav-item">
                                    <a href="/biometrico/sistema/controller/ConfiguracionesController/FeriadosController.php?action=CrearFeriado" class="nav-link">
                                        <i class="nav-icon bi bi-calendar-day"></i>
                                        <p>Crear Feriado</p>
                                    </a>
                                </li>
...
<!-- Agregar Bootstrap CSS en la sección <head> -->
